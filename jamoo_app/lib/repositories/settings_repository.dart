...
class SettingsRepository {
  ...
  static const String _applicationFolderName =
      'JamooManager';
  static const String _settingsFileName =
      'app_settings.json';
  ...
  Future<File> _resolveSettingsFile() async {
    ...
    final environmentPath = Platform
        .environment['JAMOO_SETTINGS_JSON']
        ?.trim();
